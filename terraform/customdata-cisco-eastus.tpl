...
!
router eigrp 100
 distribute-list ACL_DL_TO_WEST out Tunnel12
 distribute-list ACL_DL_TO_SOUTH out Tunnel13
...
ip route vrf GS 0.0.0.0 0.0.0.0 GigabitEthernet1 10.1.1.1 global
